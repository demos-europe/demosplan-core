...
/**
 * Tests the method that brings an AnnotatedStatementPdf from ready-to-convert to text-review.
 */
class SetBoxReviewStatusTest extends UnitTestCase
{
    ...
    public function testInvalidSetBoxReviewStatusPending(): void
    {
        $this->loginUser();
    ...
    public function testInvalidSetBoxReviewStatusReviewed(): void
    {
        $this->loginUser();
        /** @var AnnotatedStatementPdf $annotatedStatementPdf */
        $annotatedStatementPdf = $this->getReference('annotatedStatementPdf9');
    ...
    public function testInvalidSetBoxReviewStatusReadyToConvert(): void
    {
        $this->loginUser();
        /** @var AnnotatedStatementPdf $annotatedStatementPdf */
        $annotatedStatementPdf = $this->getReference('annotatedStatementPdf9');
    ...
    public function testInvalidSetBoxReviewStatusTextReview(): void
    {
        $this->loginUser();
        /** @var AnnotatedStatementPdf $annotatedStatementPdf */
        $annotatedStatementPdf = $this->getReference('annotatedStatementPdf9');
    ...
    public function testInvalidSetBoxReviewStatusConverted(): void
    {
        $this->loginUser();
        /** @var AnnotatedStatementPdf $annotatedStatementPdf */
        $annotatedStatementPdf = $this->getReference('annotatedStatementPdf9');
    ...
    public function testAccessDeniedSetBoxReviewStatus(): void
    {
    ...
    public function testValidSetBoxReviewStatus(): void
    {
        $user = $this->loginUser();
        /** @var AnnotatedStatementPdf $annotatedStatementPdf */
        $annotatedStatementPdf = $this->getReference('annotatedStatementPdf9');
        ...
        $this->assertEquals(AnnotatedStatementPdf::BOX_REVIEW, $annotatedStatementPdf->getStatus());
    }
