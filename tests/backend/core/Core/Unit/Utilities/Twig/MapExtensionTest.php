 ...
 * @group UnitTest
 */
class MapExtensionTest extends FunctionalTestCase
{
    /**
     * @var MapExtension
     */
    ...
    public function testGetFilters()
    {
        try {
            ...
            static::assertSame('convertLegacyPolygon', $result[0]->getName());
        } catch (Exception $e) {
    ...
    public function testConvertLegacy()
    {
        ...
        $result = $this->twigExtension->convertLegacyPolygonFilter($textToTest);
    ...
    public function testName()
    {
        ...
        static::assertEquals('map_extension', $result);
    }
}
