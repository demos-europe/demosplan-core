...
export const apiData = {
  ...
  included: [{
    ...
    attributes: {
      ...
      isBaseLayer: false,
      tileMatrixSet: '',
      url: 'http://geo.bolapla-sh.de/robob/services/wms_vorranggebiete?service=WMS&',
      treeOrder: 1040101,
    ...
    attributes: {
      ...
      isXplan: false,
      legend: '',
      layers: 'karte2_gebiete_mit_besonderer_erholungseignung',
      name: 'Sowieso',
      mapOrder: 0,
      opacity: 100,
      procedureId: '45752f51-f68a-11e5-b083-005056ae0004',
      ...
      isBaseLayer: false,
      tileMatrixSet: '',
      url: 'https://umweltdatenqs.schleswig-holstein.de/security-proxy/services/wms_karte2?request=GetCapabilities',
      treeOrder: 1080101,
    ...
    attributes: {
      ...
      isBaseLayer: false,
      tileMatrixSet: '',
      url: 'http://geo.bolapla-sh.de/robob/services/wms_vorranggebiete?service=WMS&request=GetCapabilities',
      treeOrder: 1080102,
      categoryId: '7b614b15-dc3c-11e8-884a-782bcb0d78b1',
      canUserToggleVisibility: true,
      visibilityGroupId: '',
    ...
    attributes: {
      ...
      isBaseLayer: true,
      tileMatrixSet: null,
      url: 'http://geo.sv.rostock.de/geodienste/stadtplan/wms?service=WMS&version=1.1.1&request=GetMap',
      treeOrder: 4,
    ...
    attributes: {
      ...
      isBaseLayer: true,
      tileMatrixSet: '',
      url: 'http://service.schleswig-holstein.de/OGCFassade/SH_WMS_DOP40c_BOBSH.aspx',
      treeOrder: 5,
      categoryId: '1b6d38af-4225-11e8-b9d0-782bcb0d78b1',
      canUserToggleVisibility: true,
      visibilityGroupId: '',
    ...
    attributes: {
      ...
      isBaseLayer: true,
      tileMatrixSet: '',
      url: 'https://sg.geodatenzentrum.de/wms_webatlasde?Service=WMS&',
      treeOrder: 0,
      categoryId: '1b6d38af-4225-11e8-b9d0-782bcb0d78b1',
      canUserToggleVisibility: true,
      visibilityGroupId: '',
    ...
    attributes: {
      ...
      isBaseLayer: true,
      tileMatrixSet: null,
      url: 'http://service.schleswig-holstein.de/OGCFassade/SH_WMS_VwG_BOBSH.aspx',
      treeOrder: 6,
      categoryId: '1b6d38af-4225-11e8-b9d0-782bcb0d78b1',
      canUserToggleVisibility: true,
      visibilityGroupId: '',
    ...
    attributes: {
      ...
      isXplan: false,
      legend: '',
      layers: 'onmaps_pastell_strassennamen',
      name: 'GeoGlis Grundkarte',
      mapOrder: 4,
      opacity: 100,
      procedureId: '45752f51-f68a-11e5-b083-005056ae0004',
      serviceType: 'wms',
    ...
    attributes: {
      ...
      url: 'https://geodienstelandesplanungstage.bob-sh.de/mapproxy/robobwind/service?REQUEST=GetCapabilities&SERVICE=WMTS',
      treeOrder: 0,
      categoryId: '1b6d38af-4225-11e8-b9d0-782bcb0d78b1',
      canUserToggleVisibility: true,
      visibilityGroupId: '',
  ...
  links: { self: 'http://robobsh.dplan.local/app_dev.php/api/1.0/procedures/45752f51-f68a-11e5-b083-005056ae0004/layers' },
