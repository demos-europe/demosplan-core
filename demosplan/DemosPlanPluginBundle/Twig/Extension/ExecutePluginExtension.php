...
namespace demosplan\DemosPlanPluginBundle\Twig\Extension;
...
class ExecutePluginExtension extends ExtensionBase
{
    public function getFunctions(): array
    {
        return [
            new TwigFunction('executePluginFunction', [$this, 'executePluginFunction']),
