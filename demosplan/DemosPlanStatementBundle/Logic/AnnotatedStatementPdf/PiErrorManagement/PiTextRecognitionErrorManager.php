...
class PiTextRecognitionErrorManager extends PiErrorManagerAbstract
{
    /**
    ...
    public function __construct(
        PiTextRecognitionRequester $piCommunication,
    ...
    {
        return $annotatedStatementPdf->getTextRecognitionPiRetries();
    }
    ...
    {
        $annotatedStatementPdf->incrementTextRecognitionPiRetries();
