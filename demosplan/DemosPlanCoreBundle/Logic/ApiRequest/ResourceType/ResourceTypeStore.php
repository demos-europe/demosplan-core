...
class ResourceTypeStore
{
    ...
    {
        return new ApiPlatformRelationshipConfig(
            'Claim',                          // Type name
            User::class,                      // Entity class
            $this->claimStateProvider,        // State provider instance
            ClaimResource::class              // API Platform resource class
        );
    }
