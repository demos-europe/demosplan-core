...
class DemosPlanMasterToebController extends BaseController
{
    ...
    public function masterToebListReport(
        ...
        return $this->render('@DemosPlanCore/DemosPlanUser/mastertoeblist_report.html.twig', [
            'procedure'    => $procedure,
            'templateVars' => $templateVars,
    ...
    public function masterToebListMerge(Request $request)
    {
        ...
        return $this->render('@DemosPlanCore/DemosPlanUser/mastertoeblist_merge.html.twig', [
            'templateVars' => $templateVars,
