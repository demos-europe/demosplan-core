 ...
 * property-read AttributeConfigBuilderInterface<Statement> $addressCustom
 * @property-read ToOneRelationshipConfigBuilderInterface<Statement, Orga> $addressCustom
 *
