...
class Version20200106150455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE _procedure (_p_id CHAR(36) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _o_id CHAR(36) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, current_slug_id CHAR(36) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, customer CHAR(36) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, procedure_type_id CHAR(36) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, statement_form_definition_id CHAR(36) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, procedure_ui_definition_id CHAR(36) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, procedure_behavior_definition_id CHAR(36) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci`, _p_name TEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_short_url VARCHAR(256) CHARACTER SET utf8 DEFAULT \'\' NOT NULL COLLATE `utf8_unicode_ci`, _o_name VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_desc TEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_phase VARCHAR(50) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_step VARCHAR(25) CHARACTER SET utf8 DEFAULT \'\' NOT NULL COLLATE `utf8_unicode_ci`, _p_logo CHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_extern_id CHAR(25) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_plis_id CHAR(36) CHARACTER SET utf8 DEFAULT \'\' NOT NULL COLLATE `utf8_unicode_ci`, _p_closed TINYINT(1) DEFAULT 0 NOT NULL, _p_deleted TINYINT(1) DEFAULT 0 NOT NULL, _p_master INT NOT NULL, _p_external_name TEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_external_desc TEXT CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_public_participation TINYINT(1) DEFAULT 0 NOT NULL, _p_public_participation_phase VARCHAR(20) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_public_participation_step VARCHAR(25) CHARACTER SET utf8 DEFAULT \'\' NOT NULL COLLATE `utf8_unicode_ci`, _p_public_participation_start DATETIME NOT NULL, _p_public_participation_end DATETIME NOT NULL, _p_public_participation_contact VARCHAR(2048) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_location_name VARCHAR(1024) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_location_postcode VARCHAR(5) CHARACTER SET utf8 DEFAULT \'\' NOT NULL COLLATE `utf8_unicode_ci`, _p_municipal_code VARCHAR(10) CHARACTER SET utf8 NOT NULL COLLATE `utf8_unicode_ci`, _p_ars VARCHAR(12) CHARACTER SET utf8 DEFAULT \'\' NOT NULL COLLATE `utf8_unicode_ci` COMMENT \'Amtlicher Regionalschluessel\', _p_created_date DATETIME NOT NULL, _p_start_date DATETIME NOT NULL, _p_end_date DATETIME NOT NULL, _p_closed_date DATETIME NOT NULL, _p_deleted_date DATETIME NOT NULL, _p_public_participation_publication_enabled TINYINT(1) DEFAULT 1 NOT NULL, agency_main_email_address VARCHAR(364) CHARACTER SET utf8 DEFAULT NULL COLLATE `utf8_unicode_ci` COMMENT \'main email address of the agency (organization) assigned to this procedure\', master_template TINYINT(1) NOT NULL, extern_id VARCHAR(50) CHARACTER SET utf8 DEFAULT \'\' NOT NULL COLLATE `utf8_unicode_ci`, UNIQUE INDEX UNIQ_D1A01D02E68E097B (procedure_ui_definition_id), INDEX IDX_D1A01D029404667A (procedure_type_id), UNIQUE INDEX UNIQ_D1A01D0281398E09 (customer), UNIQUE INDEX UNIQ_D1A01D02A0D2BC07 (procedure_behavior_definition_id), INDEX IDX_D1A01D0286245470 (_o_id), UNIQUE INDEX UNIQ_D1A01D029B14E34B (current_slug_id), UNIQUE INDEX UNIQ_D1A01D027BF2A129 (statement_form_definition_id), PRIMARY KEY(_p_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->abortIf(
            !$this->connection->getDatabasePlatform() instanceof MySQLPlatform,
            "Migration can only be executed safely on '\Doctrine\DBAL\Platforms\MySQLPlatform'."
        );
