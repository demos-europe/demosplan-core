...
class Version20230531123431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE platform_faq_category (id CHAR(36) NOT NULL, title VARCHAR(255) DEFAULT \'\' NOT NULL, type VARCHAR(50) DEFAULT \'custom_category\' NOT NULL, create_date DATETIME NOT NULL, modify_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET UTF8 COLLATE `UTF8_unicode_ci` ENGINE = InnoDB');
