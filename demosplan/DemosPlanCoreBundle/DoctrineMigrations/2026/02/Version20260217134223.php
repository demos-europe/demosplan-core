...
class Version20260217134223 extends AbstractMigration
{
    ...
    {
        return 'Create oauth_tokens table for KeyCloak token refresh, request buffering and org-aware re-auth redirect';
    }
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oauth_tokens ADD CONSTRAINT FK_C06D3296ORG FOREIGN KEY (selected_organisation_id) REFERENCES _orga (_o_id) ON DELETE SET NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE oauth_tokens DROP FOREIGN KEY FK_C06D3296ORG');
