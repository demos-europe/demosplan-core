...
class MaintenanceCommand extends CoreCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln('Starting messenger:consume scheduler_main scheduler_daily_maintenance for backwards compatibility...');
        $output->writeln('');
        $output->writeln('Please update your scripts to use:');
        $output->writeln('  <info>php bin/console messenger:consume scheduler_main scheduler_daily_maintenance</info>');
        $output->writeln('');
        ...
        $process = new Process(['php', 'bin/console', 'messenger:consume', 'scheduler_daily_maintenance', 'scheduler_main']);
