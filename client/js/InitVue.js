...
import { DpAccordion, DpNotifyContainer, dpValidateMultiselectDirective, Tooltip, DpFlyout } from '@demos-europe/demosplan-ui'
...
function initialize (components = {}, storeModules = {}, apiStoreModules = [], presetStoreModules = {}) {
  ...
  return initStore(storeModules, apiStoreModules, presetStoreModules).then(store => {
    ...
    const vm = new Vue({
       ...
       */
      components: { ...components, DpAccordion, DpNotifyContainer, NavButton, DpFlyout },
      store: store,
      mounted () {
