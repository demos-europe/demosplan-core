...
export default {
  ...
  methods: {
    ...
    showHintAndDoExport ({ route, docxHeaders, fileNameTemplate, customHeaderText, shouldConfirm, isObscured, isInstitutionDataCensored, isCitizenDataCensored, tagFilterIds }) {
