...
export default {
  ...
  methods: {
    ...
    showHintAndDoExport ({ route, docxHeaders, fileNameTemplate, shouldConfirm, isCensored, isObscured }) {
      const url = this.exportRoute(route, docxHeaders, fileNameTemplate, isCensored, isObscured)
