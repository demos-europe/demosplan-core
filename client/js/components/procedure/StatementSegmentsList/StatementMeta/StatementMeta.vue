  ...
  <div class="c-statement-meta-box u-mb-0_5">
    ...
    <div
      ...
      <div class="inline-block u-1-of-2 align-top">
        <dp-input
          ...
          @update:modelValue="(val) => emitInput('authorName', val)" />
        <dp-input
          ...
          type="email"
          @update:modelValue="(val) => emitInput('submitterEmailAddress', val)" />
        <dp-input
          ...
          @update:modelValue="(val) => emitInput('initialOrganisationName', val)" />
        <dp-input
          v-if="!this.localStatement.attributes.isSubmittedByCitizen"
          ...
          @update:modelValue="(val) => emitInput('initialOrganisationDepartmentName', val)" />
        <div class="o-form__group u-mb-0_5">
          <dp-input
            ...
            @update:modelValue="(val) => emitInput('initialOrganisationStreet', val)" />
          <dp-input
            ...
            :size="3"
            @update:modelValue="(val) => emitInput('initialOrganisationHouseNumber', val)" />
        </div>
        <div class="o-form__group u-mb-0_5">
          <dp-input
            ...
            pattern="^[0-9]{4,5}$"
            :size="5"
            @update:modelValue="(val) => emitInput('initialOrganisationPostalCode', val)" />
          <dp-input
            id="statementCity"
            ...
            @update:modelValue="(val) => emitInput('initialOrganisationCity', val)" />
        </div>
      </div><!--
   ...
   --><div class="inline-block u-1-of-2 u-pl">
        <dp-input
          ...
          @update:modelValue="(val) => emitInput('internId', val)" />
        ...
        <div class="o-form__group u-mb-0_5">
          ...
          <div
            ...
            <dp-datepicker
              ...
              @update:modelValue="(val) => setDate(val, 'authoredDate')" />
          </div>
          ...
          <div
            ...
            <dp-datepicker
              ...
              @update:modelValue="(val) => setDate(val, 'submitDate')" />
          </div>
        </div>
