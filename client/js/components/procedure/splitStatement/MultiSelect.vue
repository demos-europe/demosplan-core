...
<documentation>
  <!--
   This is the generic multiselect functional component for vue instances. It is a wrapper for vue-multiselect: https://github.com/shentao/vue-multiselect
   Component props:
...
export default {
  ...
  render (createElement, context) {
    ...
    const functions = {
      noResult: () => createElement('span', 'Keine Suchtreffer.'),
      noOptions: () => createElement('span', 'Es sind keine Einträge vorhanden.')
    }
