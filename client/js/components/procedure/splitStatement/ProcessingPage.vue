...
import { DpProgressBar } from 'demosplan-ui/components/core'
...
export default {
  ...
  props: {
     ...
     * - aiSegmented: statement was segmented by AI and is ready to be segmented by the user
